...
var ErrInvalidFacetLogic = fmt.Errorf("not a valid FacetLogic, try [%s]", strings.Join(FacetLogicNames(), ", "))
...
var _facetLogicValues = []FacetLogic{
	FacetLogicAnd,
	FacetLogicOr,
}
...
func FacetLogicNames() []string {
	names := make([]string, len(_facetLogicValues))
	for i, v := range _facetLogicValues {
		names[i] = string(v)
	}
...
func FacetLogicValues() []FacetLogic {
	return append([]FacetLogic(nil), _facetLogicValues...)
}
...
func (x *FacetLogic) AppendText(b []byte) ([]byte, error) {
...
func (x NullFacetLogic) MarshalJSON() ([]byte, error) {
	if x.Valid {
		return json.Marshal(x.FacetLogic)
	}
...
func (x *NullFacetLogic) UnmarshalJSON(b []byte) error {
	var v interface{}
...
func (x NullFacetLogic) MarshalGQL(w io.Writer) {
...
func (x *NullFacetLogic) UnmarshalGQL(v any) error {
	if v == nil {
		return nil
	}
