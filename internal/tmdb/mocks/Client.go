...
import (
	...
	tmdb "github.com/hexsans/hexmagnet/internal/tmdb"
...
// MovieDetails provides a mock function with given fields: ctx, request
func (_m *Client) MovieDetails(ctx context.Context, request tmdb.MovieDetailsRequest) (tmdb.MovieDetailsResponse, error) {
...
func (_e *Client_Expecter) MovieDetails(ctx interface{}, request interface{}) *Client_MovieDetails_Call {
...
// SearchMovie provides a mock function with given fields: ctx, request
func (_m *Client) SearchMovie(ctx context.Context, request tmdb.SearchMovieRequest) (tmdb.SearchMovieResponse, error) {
	ret := _m.Called(ctx, request)
...
func (_e *Client_Expecter) SearchMovie(ctx interface{}, request interface{}) *Client_SearchMovie_Call {
...
// SearchTv provides a mock function with given fields: ctx, request
func (_m *Client) SearchTv(ctx context.Context, request tmdb.SearchTvRequest) (tmdb.SearchTvResponse, error) {
	ret := _m.Called(ctx, request)
...
func (_e *Client_Expecter) SearchTv(ctx interface{}, request interface{}) *Client_SearchTv_Call {
...
// TvDetails provides a mock function with given fields: ctx, request
func (_m *Client) TvDetails(ctx context.Context, request tmdb.TvDetailsRequest) (tmdb.TvDetailsResponse, error) {
	ret := _m.Called(ctx, request)
...
func (_e *Client_Expecter) TvDetails(ctx interface{}, request interface{}) *Client_TvDetails_Call {
...
// ValidateAccessToken provides a mock function with given fields: ctx
func (_m *Client) ValidateAccessToken(ctx context.Context) error {
	ret := _m.Called(ctx)
...
//   - ctx context.Context
func (_e *Client_Expecter) ValidateAccessToken(ctx interface{}) *Client_ValidateAccessToken_Call {
...
func (_c *Client_ValidateAccessToken_Call) Return(_a0 error) *Client_ValidateAccessToken_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *Client_ValidateAccessToken_Call) RunAndReturn(run func(context.Context) error) *Client_ValidateAccessToken_Call {
	_c.Call.Return(run)
	return _c
}
