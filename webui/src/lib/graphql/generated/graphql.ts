...
export type DhtCrawlerQuery = { dhtCrawler: { active: boolean, torrentsCrawled: number, peersConnected: number, peersDiscovered: number, uptime: number, startedAt: string | null, recentActivity: Array<{ id: string, type: string, message: string, time: string }> } };
