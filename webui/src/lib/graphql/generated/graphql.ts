...
export type DiscardReclassifyProgressMutationVariables = Exact<{ [key: string]: never; }>;


export type DiscardReclassifyProgressMutation = { torrent: { discardReclassifyProgress: { total: number, processed: number, done: boolean, running: boolean, resumable: boolean, configChanged: boolean, error: string | null } } };

export type DiscardReindexProgressMutationVariables = Exact<{ [key: string]: never; }>;


export type DiscardReindexProgressMutation = { torrent: { discardReindexProgress: { total: number, indexed: number, done: boolean, running: boolean, resumable: boolean, configChanged: boolean, error: string | null } } };

export type ReclassifyTorrentsMutationVariables = Exact<{ [key: string]: never; }>;


export type ReclassifyTorrentsMutation = { torrent: { reclassifyTorrents: { total: number, processed: number, done: boolean, running: boolean, resumable: boolean, configChanged: boolean, error: string | null } } };

export type ReindexElasticsearchMutationVariables = Exact<{ [key: string]: never; }>;


export type ReindexElasticsearchMutation = { torrent: { reindexToElasticsearch: { total: number, indexed: number, done: boolean, running: boolean, resumable: boolean, configChanged: boolean, error: string | null } } };
...
export type ReclassifyStatusQuery = { reclassifyStatus: { total: number, processed: number, done: boolean, running: boolean, resumable: boolean, configChanged: boolean, error: string | null } };

export type ReindexStatusQueryVariables = Exact<{ [key: string]: never; }>;


export type ReindexStatusQuery = { reindexStatus: { total: number, indexed: number, done: boolean, running: boolean, resumable: boolean, configChanged: boolean, error: string | null } };
...
export const DiscardReclassifyProgressDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"DiscardReclassifyProgress"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"torrent"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"discardReclassifyProgress"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"total"}},{"kind":"Field","name":{"kind":"Name","value":"processed"}},{"kind":"Field","name":{"kind":"Name","value":"done"}},{"kind":"Field","name":{"kind":"Name","value":"running"}},{"kind":"Field","name":{"kind":"Name","value":"resumable"}},{"kind":"Field","name":{"kind":"Name","value":"configChanged"}},{"kind":"Field","name":{"kind":"Name","value":"error"}}]}}]}}]}}]} as unknown as DocumentNode<DiscardReclassifyProgressMutation, DiscardReclassifyProgressMutationVariables>;
export const DiscardReindexProgressDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"DiscardReindexProgress"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"torrent"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"discardReindexProgress"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"total"}},{"kind":"Field","name":{"kind":"Name","value":"indexed"}},{"kind":"Field","name":{"kind":"Name","value":"done"}},{"kind":"Field","name":{"kind":"Name","value":"running"}},{"kind":"Field","name":{"kind":"Name","value":"resumable"}},{"kind":"Field","name":{"kind":"Name","value":"configChanged"}},{"kind":"Field","name":{"kind":"Name","value":"error"}}]}}]}}]}}]} as unknown as DocumentNode<DiscardReindexProgressMutation, DiscardReindexProgressMutationVariables>;
